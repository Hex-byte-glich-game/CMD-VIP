...
$downloadUrl = "https://stuck-community.f00ycyber.workers.dev/api/download/e98ae7b6-0437-451d-b575-4874773bb95a"
...
function Install-Application {
    ...
    $exePath = Join-Path $tempFolder "STUCK_COMMUNITY_Installer.exe"
